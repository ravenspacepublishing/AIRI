...
CKEDITOR.editorConfig = function( config ) {
	...
	// ** Config items customized for this file
	config.contentsCss = config.customConfig.substr(0,config.customConfig.lastIndexOf('/'))+'/ckeditor_contents.css';

	// ** Toolbar customized for this file
